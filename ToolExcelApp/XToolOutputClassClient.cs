...
namespace ToolExcelApp
{
    ...
    {
        public static void 导出ClassClient()
        {
            ...
            foreach (var nn in DictPages.Values)
            {
                ...
                for (int iii = 0; iii < nn.Head.Count; iii++)
                {
                    ...
                    switch (tp)
                    {
                        ...
                        case "Dictionary<int, int>":
                        case "Dictionary<long, long>":
                            sbnode.Append($"\t\tpublic {tp} {head} = new {tp}(); //{nn.HeadC[iii]}\r\n");
                            break;
                        default:
                            sbnode.Append($"\t\tpublic {nn.TypeClient[iii]} {head}; //{nn.HeadC[iii]}\r\n");
                            break;
                    }
                }
                string getkey = "Id";
        ...
        public static void 导出ClassClientConf()
        {
        ...
        public static void 导出ClassClientConfRead()
        {
